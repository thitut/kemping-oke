...
<div class="form-group col-sm-6">
    {!! Form::label('tanggal_pinjam', 'Tanggal Pnjam:') !!}
    {!! Form::date('tanggal_pinjam', \Carbon\Carbon::now(), ['class' => 'form-control']) !!}
</div>
<!-- Tanggal Field -->
<div class="form-group col-sm-6">
    {!! Form::label('tanggal_kembali', 'Tanggal Kembali:') !!}
    {!! Form::date('tanggal_kembali', \Carbon\Carbon::now(), ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('penyewaans.index') !!}" class="btn btn-default">Cancel</a>
</div>
